## Данный проект тестовое здание от компании: Алитикс.

### Демо версия -<a href="https://test-tast-a.herokuapp.com/" target="_blank"> проекта</a>
...
```javascript
git clone https://github.com/KasumovW/test-task.git
```
